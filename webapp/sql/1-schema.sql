...
(
  ...
  created_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '登録日時',
  PRIMARY KEY (id),
  KEY chair_locations_chair_id_created_at_idx (chair_id, created_at)
)
...
(
  ...
  KEY rides_chair_id_created_at_idx (chair_id, created_at)
)
  COMMENT = 'ライド情報テーブル';
...
(
  ...
  PRIMARY KEY (id),
  KEY ride_statuses_ride_id_created_at_status_idx (ride_id, created_at, status),
